...
with(data, {
    ...
    plot(Time, Sub_metering_1, type="n", cex.axis=0.8, cex.lab=0.8, xlab="", 
    ...
    plot(Time, Global_reactive_power, type="n", xlab="datetime", 
         ylim=c(0.0,0.5), cex.axis=0.8, cex.lab=0.8)
